...
const Home = () => {
    ...
    //     let currentIndex = 0;
    //     var headingTyped = new Typed(headingRef.current, {
    //         strings: [rotations[currentIndex]],
    //         typeSpeed: 150,
    //         backSpeed: 150,
    //         loop: true,
    //         showCursor: true,
                ...
                <div>
                    <ul>
                        ...
                        <li>5. Answer using graphs (if possible) with dummy<br></br>
                             values more and less than given values.</li>
                        <li>6. Recommendations to increase and decrease <br></br> the values.</li>
                        <li>7. Save the result like other sections.</li>
                        <li>8. Ask anything, can translate the answer and can listen.</li>
                        <li>9. Can learn in a step-by-step way like in the <br></br> compiler section.</li>
                        <li>10. Detail of all formulas will be given in detail button.</li>
                        <li>read more</li>
                    </ul>
                </div>
            ...
            <div className="services">
               ...
               <div className="container">
                   ...
                   <div className="row" >
                       ...
                       <div className="col-md-3 d-flex align-items-center justify-content-center" id="Second">
                           <div className="services-box text-center" onClick={() => handleChemicalsClick('Codes')}>
                               <div className="services-icon">
                                   <img src={programingImg} className="img-fluid" alt=""  />
                               </div>
